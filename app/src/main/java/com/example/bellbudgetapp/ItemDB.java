...
public class ItemDB {
    public static final String[] constructionNames = {
        "Log Bridge", "Suspension Bridge", "Wooden Bridge", "Stone Bridge", "Brick Bridge", "Zen Bridge", "Red Zen Bridge", "Iron Bridge"
    };
